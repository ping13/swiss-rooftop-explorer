...
; 
" |  tippecanoe -o $4 --force -J $SCRIPT_DIR/roofs.filter.json -zg -l roof  --progress-interval=10 --no-feature-limit --no-tile-size-limit --no-clipping  # --visvalingam --no-simplification-of-shared-nodes  --no-line-simplification --use-source-polygon-winding --no-clipping 
